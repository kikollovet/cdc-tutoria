...
public class TestaUltimosLancamentos {
	...
	public static void main(String[] args) {
		...
		Livro l1 = new Livro("ASP.NET MVC5", "Crie aplicações Web na plataforma Microsoft", everton, Tipo.EBOOK, 29.90, "10/10/2017", "20/03/2017");
		site.inclui(l1);
		...
		Livro l3 = new Livro("Coleção CodeIgniter + Zend PHP", "", jMM, Tipo.EBOOK, 49.90, "08/10/2017", "10/03/2017");
		site.inclui(l3);
		...
		Livro l4 = new Livro("Elasticsearch", "Consumindo dados real-time com ELK", alexandre, 
				Tipo.EBOOK, 29.90, "07/10/2017", "05/03/2017");
		site.inclui(l4);
		...
		Livro l5 = new Livro("Java SE 8 Programmer I", "O guia para sua certificação Oracle Certified Associate", 
				gM, Tipo.EBOOK, 29.90, "06/10/2017", "03/03/2017");
		site.inclui(l5);
		...
		Livro l6 = new Livro("Guia da Startup", "Como startups e empresas estabelecidas podem criar produtos de software rentáveis", 
				joaquim, Tipo.EBOOK, 29.90, "05/10/2017", "01/03/2017");
		site.inclui(l6);
